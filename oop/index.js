...
rahmatAsuransi = new Asuransi('Rahmat', 30, 'laki-laki', 'asuransi', 'Muntaber', 0, 'Kelas 1', false);
rumahSakit.checkIn(rahmatAsuransi);
// console.log(rahmatAsuransi);

let japriAsuransi = new Asuransi('Japri', 35, 'laki-laki', 'asuransi', 'Tipes', 0, 'Kelas 1', false);
